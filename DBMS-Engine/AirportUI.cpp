...
{
    cout << "Enter the name of the passenger and the name of "
            "the list the passenger should be removed from:" << endl;
    string name, list;
    if(!(cin >> name >> list))
        throw "Invalid input! Try again!";
...
void AirportUI::remove_plane()
{
    ...
    if(!(cin >> model >> list))
        throw "Invalid input! Try again!";
    database.removePlane(model, list);
}
...
{
    cout << "Enter the name of the passenger, the name of the list, "
            "and the updated number of baggage:" << endl;
    int baggage;
    string name, list;
    if(!(cin >> name >> list >> baggage))
        throw "Invalid input! Try again!";
